# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 08:31:57 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 23:51:25 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 22:33:31 2021
...
X_train, X_test, y_train, y_test =fetch_ucr_dataset('Wafer', use_cache=True, data_home=None, return_X_y=True)


for x in range(0,50):
 
   _m =  salp_swarm_algorithm(swarm_size =80, min_values = [1.0,1.0], max_values = [0.90,0.90], iterations = 1000, target_function = rosenbrocks_valley)
   _c = salp_swarm_algorithm(swarm_size = 80, min_values = [0.85,0.85], max_values = [0.55,0.55], iterations = 1000, target_function = rosenbrocks_valley)
   _s = salp_swarm_algorithm(swarm_size = 80, min_values = [0.6, 0.6], max_values = [0.3,0.3], iterations = 1000, target_function = rosenbrocks_valley)
...
ypredfile = 'univariate ypred.xlsx'
...
filepath2 = 'univariate ytest.xlsx'
