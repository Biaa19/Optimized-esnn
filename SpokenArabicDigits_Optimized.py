# -*- coding: utf-8 -*-
"""
Created on Sun May  9 04:49:58 2021
...
X_trainlist=[]
X_testlist=[]
X_train, X_test, y_train, y_test =fetch_uea_dataset('SpokenArabicDigits', use_cache=True, data_home=None, return_X_y=True)
