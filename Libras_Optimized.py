...
X_trainlist=[]
X_testlist=[]
X_train, X_test, y_train, y_test =fetch_uea_dataset('Libras', use_cache=True, data_home=None, return_X_y=True)
...
for x in range(0,50):
   ...
   _c = salp_swarm_algorithm(swarm_size = 80, min_values = [0.80,0.80], max_values = [0.70,0.70], iterations = 500, target_function = rosenbrocks_valley)
...
df = pd.DataFrame (y_predlist)

## save to xlsx file

filepath = 'LIBRAS ypred.xlsx'
